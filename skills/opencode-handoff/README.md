...
- `opencode-handoff.skill` — the installable distributable

---

*Part of the [Claude-Powerhouse](../../README.md) suite. Pairs with [software-team](../software-team/) (PM/Dev/QA pipeline) and `/powerhouse` (unified command).*
